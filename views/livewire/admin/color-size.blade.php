<div class="mt-4">
    ...
    <!--tabla-->
    @if ($size_colors->count())<!--si tenemos un elemento en la tabla esta se muestra-->
        <!--Tabla--> 
    <div class="mt-8">
        <table>
            <thead>
            ...
            <tbody>
                @foreach ($size_colors as $size_color)<!--iteracion-->
                    <tr wire:key="size_color-{{$size_color->pivot->id}}"><!--llave identifedicadora-->
                        ...
                        <td class="px-4 py-2 flex">
                                ...
                                wire:target="edit({{$size_color->pivot->id}})"><!--cuando hacemos click en el boton actualizar acceda al metodo edit-->
                                Actualizar           
                                ...
                                <x-jet-danger-button
                                    wire:click="$emit('deleteColorSize', {{ $size_color->pivot->id }})"><!-- se ejecuta este elemento magico cuando hagamos click y llame al id del producto -->
                                    Eliminar
                                </x-jet-danger-button>
                        </td>
                    </tr>
